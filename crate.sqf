...
(_this select 0) addWeaponCargoGlobal [_selectedWeapon, _randomWeaponNumber];
//0-2 Items werden in die Kiste getan
_randomItemNumber = floor (random 3);
(_this select 0) addItemCargoGlobal [_selectedItem, _randomItemNumber];
//1-6 Magazine werden in die Kiste getan
_randomMagNumber = ceil (random 6);
(_this select 0) addMagazineCargoGlobal [_selectedMag, _randomMagNumber];
//0-2 Backpacks werden in die Kiste getan
_randomBPNumber = floor (random 3);
(_this select 0) addBackpackCargoGlobal [_selectedBackpack, _randomBPNumber];
//1-15 Medicalzeug wird in die Kiste getan
_randomMedicalNumber = ceil (random 15);
(_this select 0) addItemCargoGlobal [_selectedMedical, _randomMedicalNumber];
...
(_this select 0) addItemCargoGlobal [_selectedGrenade, _randomGrenadeNumber];
//0-2 Accessorys werden in die Kiste getan
_randomAccNumber = floor (random 3);
(_this select 0) addItemCargoGlobal [_selectedAccessory, _randomAccNumber];
//0-2 Sights werden in die Kiste getan
_randomSightNumber = floor (random 3);
(_this select 0) addItemCargoGlobal [_selectedSight, _randomSightNumber];
...
dann kiste füllen
13:31
(_this select 0) addWeaponCargoGlobal _selectedWeapon;
13:31
