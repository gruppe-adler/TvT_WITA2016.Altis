...
[{
    {[player, 1] call grad_lbm_fnc_setPermissionLevel} remoteExec ["call",WEST,QGVAR(unlockBluforVehicles)];
...
[{
    {[player, 2] call grad_lbm_fnc_setPermissionLevel} remoteExec ["call",WEST,QGVAR(unlockBluforVehicles)];
