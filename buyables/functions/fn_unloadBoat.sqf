...
_boatsLeft = _box getVariable ["wita_buyables_boatsInBox",0];
if (_boatsLeft < 1) exitWith {};

_boatType = _box getVariable ["wita_buyables_boatType",""];
if (_boatType == "") exitWith {};

_box setVariable ["wita_buyables_boatsInBox",_boatsLeft-1,true];
