...
[{
    ...
    _args params ["_agent","_markerVarianceDefault","_markerIntervalDefault","_markerFadeoutDefault","_markerVarianceBase","_markerIntervalBase","_markerFadeoutBase"];
    ...
    if (_agent inArea WITA_BLUFORBASEAREA) then {
        ...
        _currentInterval = _markerIntervalDefault;
...
} , 1, [_agent,_markerVarianceDefault,_markerIntervalDefault,_markerFadeoutDefault,_markerVarianceBase,_markerIntervalBase,_markerFadeoutBase]] call CBA_fnc_addPerFrameHandler;
