...
private _spawnPos = if (count _nearRoads == 0) then {ERROR_1("No roads found near startposition."); [_searchPos,[0,30],[0,360],_startVehicle] call wita_common_fnc_findRandomPos} else {getPos (_nearRoads select 0)};
